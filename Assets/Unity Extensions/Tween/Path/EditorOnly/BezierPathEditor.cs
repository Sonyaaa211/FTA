                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (_selectedType == -1 && selectedNode == i)
                    {
                        using (var scope = ChangeCheckScope.New(path))
                        {
                            ...
                            if (selectedTool == 0) { var fmh_97_88_638357431213814486 = Quaternion.identity; back = Handles.FreeMoveHandle(back, capSize * 2, snap, Handles.RectangleHandleCap); }
                    ...
                    if (_selectedType == 1 && selectedNode == i)
                    {
                        ...
                        {
                            Handles.color = capSelectedColor;
                            if (selectedTool == 0) { var fmh_121_94_638357431213835936 = Quaternion.identity; forward = Handles.FreeMoveHandle(forward, capSize * 2, snap, Handles.RectangleHandleCap); }
                    ...
                    if (_selectedType == 0 && selectedNode == i)
                    {
                        ...
                        {
                            Handles.color = capSelectedColor;
                            if (selectedTool == 0) { var fmh_144_92_638357431213839436 = Quaternion.identity; middle = Handles.FreeMoveHandle(middle, capSize * 2, snap, Handles.RectangleHandleCap); }
