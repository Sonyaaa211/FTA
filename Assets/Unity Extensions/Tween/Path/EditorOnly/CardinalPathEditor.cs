                ...
                if (_showTension)
                {
                    for (int i = 0; i < path.segmentCount; i++)
                    {
                        ...
                        using (var scope = ChangeCheckScope.New(path))
                        {
                            ...
                            var fmh_82_67_638357431214005716 = Quaternion.identity; point = Handles.FreeMoveHandle(point, capSize, snap, Handles.CircleHandleCap);
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (selectedNode == i)
                    {
                        using (var scope = ChangeCheckScope.New(path))
                        {
                            ...
                            if (selectedTool == 0) { var fmh_118_96_638357431214008911 = Quaternion.identity; position = Handles.FreeMoveHandle(position, capSize * 2, snap, Handles.RectangleHandleCap); }
